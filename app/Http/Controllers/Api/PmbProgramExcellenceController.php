...
use App\Models\PmbProgramExcellence;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\Storage;
use Illuminate\Support\Facades\Validator;

class PmbProgramExcellenceController extends Controller
{
    public function show()
    {
        try {
            $data = PmbProgramExcellence::first();
    ...
    public function update(Request $request)
    {
        try {
            ...
            $currentData = PmbProgramExcellence::first();
            ...
            if ($currentData) {
                ...
                $currentData = PmbProgramExcellence::create($fields);

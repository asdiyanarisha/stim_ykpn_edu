...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo-head','data' => ['title' => 'Pengumuman Mahasiswa Diterima — STIM YKPN Yogyakarta','description' => 'Pengumuman resmi daftar mahasiswa yang diterima di STIM YKPN Yogyakarta.','canonicalUrl' => url('/pengumuman-diterima')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Pengumuman Mahasiswa Diterima — STIM YKPN Yogyakarta','description' => 'Pengumuman resmi daftar mahasiswa yang diterima di STIM YKPN Yogyakarta.','canonicalUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url('/pengumuman-diterima'))]); ?>
...
<header class="page-header">
    <div class="container" style="position:relative; z-index:2;">
      <h1 class="page-title animate-on-scroll">Pengumuman Diterima</h1>
      <p class="page-subtitle animate-on-scroll animate-delay-1" style="max-width: 600px; margin: 0 auto;">Hasil seleksi
        penerimaan mahasiswa baru STIM YKPN Yogyakarta.</p>
    </div>
  </header>
    ...
    <div class="container academic-layout">
      ...
      <aside class="academic-sidebar animate-on-scroll">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="/pengumuman-diterima" class="active">Pengumuman Diterima</a></li>
        </ul>
      </aside>
      ...
      <article class="academic-article animate-on-scroll animate-delay-1">
        <div class="article-header">
          <h2>Pengumuman Hasil Seleksi PMB</h2>
        </div>
        <div class="article-body">

          <div
            style="text-align: center; padding: 50px 20px; background: #f8f9fa; border-radius: 12px; border: 1px dashed #ccc; margin-top: 20px;">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="var(--primary-blue)" stroke-width="2"
              stroke-linecap="round" stroke-linejoin="round" style="margin-bottom: 20px; opacity: 0.7;">
            ...
            <h3 style="color: #444; font-size: 1.3rem; margin-bottom: 15px;">Belum Ada Pengumuman Terbaru</h3>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\arief\stim_ykpn_edu\resources\views/pengumuman-diterima.blade.php ENDPATH**/ ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo-head','data' => ['title' => 'Berita & Kegiatan Kampus — STIM YKPN Yogyakarta','description' => 'Berita terbaru, kegiatan kampus, prestasi, dan pengumuman seputar STIM YKPN Yogyakarta.','canonicalUrl' => url('/berita')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Berita & Kegiatan Kampus — STIM YKPN Yogyakarta','description' => 'Berita terbaru, kegiatan kampus, prestasi, dan pengumuman seputar STIM YKPN Yogyakarta.','canonicalUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url('/berita'))]); ?>
        ...
        <div class="news-page-grid" id="newsGrid">
          ...
          <article class="news-card">
            <div class="news-card-image">
              <img loading="lazy" src="<?php echo e($news_item->url_image ?? '/images/hero-bg.webp'); ?>" alt="<?php echo e($news_item->title); ?>">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\arief\stim_ykpn_edu\resources\views/berita.blade.php ENDPATH**/ ?>
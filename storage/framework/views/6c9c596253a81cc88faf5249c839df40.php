...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo-head','data' => ['title' => 'Program Ekstensi (Kelas Karyawan) — STIM YKPN Yogyakarta','description' => 'Program ekstensi khusus karyawan di STIM YKPN Yogyakarta. Kuliah sore-malam, tetap bisa bekerja sambil meningkatkan jenjang pendidikan.','canonicalUrl' => url('/program-ekstensi')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Program Ekstensi (Kelas Karyawan) — STIM YKPN Yogyakarta','description' => 'Program ekstensi khusus karyawan di STIM YKPN Yogyakarta. Kuliah sore-malam, tetap bisa bekerja sambil meningkatkan jenjang pendidikan.','canonicalUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url('/program-ekstensi'))]); ?>
    ...
    <div class="container academic-layout">
      ...
      <aside class="academic-sidebar animate-on-scroll">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="/program-ekstensi" class="active">Program Ekstensi</a></li>
      ...
      <article class="academic-article animate-on-scroll animate-delay-1">
        ...
        <div class="article-body">
          ...
          <a href="/pendaftaran-pmb" class="btn btn-orange" style="margin-top: 30px; display: inline-block;">Daftar Sekarang</a>
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\arief\stim_ykpn_edu\resources\views/program-ekstensi.blade.php ENDPATH**/ ?>
...
<nav class="navbar" id="navbar">
  <div class="container">
    ...
    <ul class="nav-links" id="navLinks">
      ...
      <li class="dropdown">
        <a href="<?php echo e($pmbSite); ?>/">PMB <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="m6 9 6 6 6-6" />
          </svg></a>
        <ul class="dropdown-menu">
          <li><a href="<?php echo e($pmbSite); ?>/">Pendaftaran</a></li>
          ...
          <li><a href="<?php echo e($pmbSite); ?>/pengumuman-diterima">Pengumuman Diterima</a></li>
        </ul>
      </li>
      <li class="dropdown">
  ...
  <div class="mobile-menu-body">
    <nav class="mobile-nav-list">
      ...
      <div class="mobile-nav-group">
        ...
        <div class="mobile-submenu">
          <a href="<?php echo e($pmbSite); ?>/">Informasi Pendaftaran</a>
          <a href="<?php echo e($pmbSite); ?>/biaya-kuliah">Biaya Kuliah</a>
          <a href="<?php echo e($pmbSite); ?>/beasiswa">Beasiswa</a>
          <a href="<?php echo e($pmbSite); ?>/program-reguler">Program Reguler</a>
          <a href="<?php echo e($pmbSite); ?>/program-ekstensi">Program Ekstensi</a>
          <a href="<?php echo e($pmbSite); ?>/pengumuman-diterima">Pengumuman Diterima</a>
        </div>
      </div>

...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.seo-head','data' => ['title' => 'Unit Kegiatan Mahasiswa (UKM) — STIM YKPN Yogyakarta','description' => 'Daftar lengkap Unit Kegiatan Mahasiswa (UKM) di STIM YKPN Yogyakarta. Wadah pengembangan minat, bakat, dan kreativitas mahasiswa.','canonicalUrl' => url('/ukm')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Unit Kegiatan Mahasiswa (UKM) — STIM YKPN Yogyakarta','description' => 'Daftar lengkap Unit Kegiatan Mahasiswa (UKM) di STIM YKPN Yogyakarta. Wadah pengembangan minat, bakat, dan kreativitas mahasiswa.','canonicalUrl' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(url('/ukm'))]); ?>
      ...
      <?php $__currentLoopData = $ukms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ukm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="ukm-card">
          <div class="ukm-image-container">
            ...
            ?>
            <img src="<?php echo e($src); ?>" alt="<?php echo e($ukm->title); ?>" class="ukm-image">
          </div>
          <div class="ukm-content">
            ...
            <div class="ukm-info">
              <div class="ukm-info-item">
                ...
                <span><strong>Jadwal:</strong><br><?php echo e($ukm->day); ?> - 
                <?php
                ...
                ?>
                <?php echo e($timeDisplay); ?> WIB</span>
              </div>
              <div class="ukm-info-item">
...
<?php echo $__env->make('layouts.public', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\arief\stim_ykpn_edu\resources\views/ukm.blade.php ENDPATH**/ ?>
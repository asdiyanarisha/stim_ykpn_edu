      ...
      >
        <div v-if="isLoading || isSubmitting" class="absolute inset-0 z-[60] bg-slate-50/80 backdrop-blur-sm flex items-center justify-center">
            <div class="flex flex-col items-center">
                ...
                <p class="text-slate-500 font-medium animate-pulse">{{ isSubmitting ? 'Menyimpan perubahan...' : 'Memuat halaman...' }}</p>
            </div>
        </div>
      </transition>
        ...
        <div class="max-w-4xl mx-auto mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div class="flex items-center gap-2 text-sm text-slate-500 mb-2">
              ...
              <span class="text-slate-900 font-medium">Tambah Prestasi</span>
            </div>
            <h1 class="text-2xl font-bold text-slate-900">Formulir Prestasi Baru</h1>
            <p class="text-slate-500">Tulis dan publikasikan pencapaian terbaru STIM YKPN.</p>
          </div>
    ...
    try {
        ...
        if (response.data.status === 'success') {
            await Swal.fire({
                icon: 'success',
                title: 'Berhasil!',
                text: 'Prestasi baru telah ditambahkan.',

        ...
        <div class="max-w-4xl mx-auto mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div class="flex items-center gap-2 text-sm text-slate-500 mb-2">
              ...
              <span class="text-slate-900 font-medium">Profil & Sejarah</span>
            </div>
            <h1 class="text-2xl font-bold text-slate-900">Profil & Sejarah STIM YKPN</h1>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              <h2 class="text-lg font-bold text-slate-800 mb-6 flex items-center gap-2">
                ...
                Detail Profil & Sejarah
              </h2>

              <div class="space-y-6">
                <AppInput v-model="form.title" label="Judul" placeholder="Misal: Sejarah STIM YKPN Yogyakarta" id="history-title" :error="errors.title" />
...
const editorOptions = {
  placeholder: 'Tuliskan sejarah dan profil STIM YKPN di sini...',
  theme: 'snow',
  modules: {
    toolbar: [

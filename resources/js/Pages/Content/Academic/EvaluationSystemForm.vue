...
const editorOptions = {
  placeholder: 'Tuliskan rincian sistem evaluasi di sini...',
  theme: 'snow',
  modules: {
    toolbar: [
...
const fetchData = async () => {
    ...
    try {
        ...
        const response = await axios.get('/api/evaluation-system', {
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const response = await axios.post('/api/evaluation-system', formData, {
      headers: {

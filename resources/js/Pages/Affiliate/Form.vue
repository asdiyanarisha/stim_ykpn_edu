      ...
      >
        <div v-if="isLoading" class="absolute inset-0 z-[60] bg-slate-50/80 backdrop-blur-sm flex items-center justify-center">
            <div class="flex flex-col items-center">
                ...
                <p class="text-slate-500 font-medium">Memuat halaman...</p>
            </div>
        </div>
      </transition>
        ...
        <div class="max-w-4xl mx-auto mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div class="flex items-center gap-2 text-sm text-slate-500 mb-2">
              ...
              <span class="text-slate-900 font-medium">Tambah Affiliate</span>
            </div>
            <h1 class="text-2xl font-bold text-slate-900">Formulir Affiliate Baru</h1>
            <p class="text-slate-500">Buat mitra affiliate baru beserta akun loginnnya.</p>
          </div>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <!-- Password -->
                <AppInput v-model="form.password" label="Password *" type="password" placeholder="Password Akun" id="affiliate-password" :error="errors.password" />
...
const handleSubmit = async () => {
  ...
  if (!form.password.trim()) { errors.password = 'Password wajib diisi'; hasError = true; }
  ...
  try {
    ...
    const response = await axios.post('/api/affiliates', form, {
    ...
    if (response.data.status === 'success') {
      await Swal.fire({
        icon: 'success',
        title: 'Berhasil!',
        text: 'Data affiliate baru berhasil ditambahkan.',

        ...
        <div class="max-w-4xl mx-auto mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <div class="flex items-center gap-2 text-sm text-slate-500 mb-2">
              ...
              <span class="text-slate-900 font-medium">Program Reguler</span>
            </div>
            <h1 class="text-2xl font-bold text-slate-900">Program Reguler</h1>
            <p class="text-slate-500">Kelola informasi mengenai program reguler di STIM YKPN.</p>
          </div>
        </div>
          ...
          <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div class="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
              <h2 class="text-lg font-bold text-slate-800 mb-6 flex items-center gap-2">
                ...
                Detail Program Reguler
              </h2>

              <div class="space-y-6">
                <AppInput v-model="form.title" label="Judul" placeholder="Misal: Program Reguler STIM YKPN" id="pmb-title" :error="errors.title" />
...
const editorOptions = {
  placeholder: 'Tuliskan informasi program reguler di sini...',
  theme: 'snow',
  modules: {
    toolbar: [
...
const fetchData = async () => {
    ...
    try {
        ...
        const response = await axios.get('/api/pmb/program-reguler', {
...
const handleSubmit = async () => {
  ...
  try {
    ...
    const response = await axios.post('/api/pmb/program-reguler', formData, {
      headers: {

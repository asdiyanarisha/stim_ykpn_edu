...
<head>
  <x-seo-head
    title="Brosur & Materi PMB — STIM YKPN Yogyakarta"
    description="Unduh brosur resmi dan materi penerimaan mahasiswa baru STIM YKPN Yogyakarta."
    :canonicalUrl="url('/brosur')"
  />
  <!-- Favicon -->

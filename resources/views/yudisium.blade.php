...
<head>
  <x-seo-head
    title="Yudisium — STIM YKPN Yogyakarta"
    description="Informasi dan jadwal yudisium mahasiswa STIM YKPN Yogyakarta."
    :canonicalUrl="url('/yudisium')"
  />
  <!-- Favicon -->
...
<body>
  ...
  <header class="page-header">
    <div class="container" style="position:relative; z-index:2;">
      <h1 class="page-title animate-on-scroll">Yudisium</h1>
      <p class="page-subtitle animate-on-scroll animate-delay-1" style="max-width: 600px; margin: 0 auto;">Ketentuan dan prosedur pendaftaran yudisium bagi mahasiswa semester akhir.</p>
    </div>
  </header>
    ...
    <div class="container academic-layout">
      ...
      <aside class="academic-sidebar animate-on-scroll">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="/yudisium.html" class="active">Yudisium</a></li>
        </ul>
      </aside>
      ...
      <article class="academic-article animate-on-scroll animate-delay-1">
        <div class="article-header">
          <h2>Pendaftaran Yudisium</h2>
        </div>
        <div class="article-body">
          
          <p>Mahasiswa semester terakhir yaitu mahasiswa yang pada akhir suatu semester secara teoritis akan dapat menyelesaikan studinya sesuai ketentuan kelulusan. Mahasiswa yang bersangkutan harus mendaftarkan diri untuk mengikuti yudisium. Apabila tidak menghendaki lulus pada semester tersebut, mahasiswa yang bersangkutan harus mendaftarkan penundaan yudisium.</p>

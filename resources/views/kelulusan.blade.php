...
@section('seo')
  <x-seo-head
    title="Syarat Kelulusan — STIM YKPN Yogyakarta"
    description="Syarat dan ketentuan kelulusan mahasiswa STIM YKPN Yogyakarta beserta informasi wisuda."
    :canonicalUrl="url('/kelulusan')"
  />
@endsection
    ...
    <div class="container academic-layout">
      ...
      <aside class="academic-sidebar animate-on-scroll">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="/kelulusan" class="active">Kelulusan</a></li>

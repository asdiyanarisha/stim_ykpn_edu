...
<head>
  <x-seo-head
    title="Logo & Identitas Visual STIM YKPN Yogyakarta"
    description="Logo resmi dan identitas visual Sekolah Tinggi Ilmu Manajemen YKPN Yogyakarta."
    :canonicalUrl="url('/logo')"
  />
  <!-- Favicon -->

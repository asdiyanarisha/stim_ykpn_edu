...
<head>
  <x-seo-head
    title="Video Campus Life — STIM YKPN Yogyakarta"
    description="Video kehidupan kampus, kegiatan mahasiswa, dan campus tour STIM YKPN Yogyakarta."
    :canonicalUrl="url('/video')"
  />
  <!-- Favicon -->

...
@section('seo')
  <x-seo-head
    title="S1 Manajemen — STIM YKPN Yogyakarta"
    description="Program Studi S1 Manajemen STIM YKPN Yogyakarta terakreditasi Baik Sekali. Siap mencetak pemimpin bisnis dan manajer masa depan."
    :canonicalUrl="url('/program/s1-manajemen')"
  />
@endsection
...
<!-- 1. HERO SECTION -->
  <header class="program-hero">
    ...
    <div class="container">
      ...
      <h1 class="hero-title animate-on-scroll">Sarjana (S1) Manajemen</h1>
  ...
  <div class="container content-layout">
    ...
    <article class="article-block animate-on-scroll">
      <h2 class="section-title">Mengapa S1 Manajemen STIM YKPN?</h2>
      <div class="prose">
        <p>
    ...
    <article class="article-block animate-on-scroll">
      ...
      <div class="prose">
        <p>
          Lulusan S1 Manajemen STIM YKPN Yogyakarta memiliki rekam jejak yang sangat baik dan tersebar di berbagai sektor strategis, baik itu di BUMN, perusahaan multinasional, instansi pemerintahan, maupun sukses merintis <i>startup</i> mereka sendiri.
        </p>
      </div>

...
@section('seo')
  <x-seo-head
    title="Tata Tertib Ujian — STIM YKPN Yogyakarta"
    description="Tata tertib dan peraturan pelaksanaan ujian yang wajib dipatuhi mahasiswa STIM YKPN Yogyakarta."
    :canonicalUrl="url('/tata-tertib-ujian')"
  />
@endsection
    ...
    <div class="container academic-layout">
      ...
      <aside class="academic-sidebar animate-on-scroll">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="/tata-tertib-ujian" class="active">Tata Tertib Ujian</a></li>

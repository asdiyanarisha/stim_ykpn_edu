...
<body>
    ...
    <section class="news-page-section">
      <div class="container">
        ...
        <div class="news-toolbar animate-on-scroll">
          <input type="text" class="news-search-input" id="newsSearchInput" placeholder="Cari berita...">
  ...
  <script>
    // Note: Search and filter functionality will require an AJAX endpoint or full page reload.
    // Since this is a static-like view right now, the toolbar is currently visual.
  </script>
</body>
</html>

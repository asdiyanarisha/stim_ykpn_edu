...
@section('seo')
  <x-seo-head
    title="Cara Mencapai Sasaran Pendidikan — STIM YKPN Yogyakarta"
    description="Strategi dan metode pencapaian sasaran pendidikan di STIM YKPN Yogyakarta melalui kurikulum berbasis kompetensi."
    :canonicalUrl="url('/cara-mencapai-sasaran')"
  />
@endsection
    ...
    <div class="container academic-layout">
      ...
      <aside class="academic-sidebar animate-on-scroll">
        ...
        <ul class="sidebar-menu">
          ...
          <li><a href="/cara-mencapai-sasaran" class="active">Cara Mencapai Sasaran</a></li>

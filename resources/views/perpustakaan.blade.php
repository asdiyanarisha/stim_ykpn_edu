...
<head>
  <x-seo-head
    title="Perpustakaan — STIM YKPN Yogyakarta"
    description="Fasilitas perpustakaan STIM YKPN Yogyakarta dengan koleksi buku manajemen, jurnal ilmiah, dan akses database akademik."
    :canonicalUrl="url('/perpustakaan')"
  />
  <!-- Favicon -->

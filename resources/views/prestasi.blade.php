...
<head>
  <x-seo-head
    title="Prestasi Mahasiswa & Institusi — STIM YKPN Yogyakarta"
    description="Kumpulan prestasi gemilang mahasiswa dan institusi STIM YKPN Yogyakarta di berbagai kompetisi nasional dan internasional."
    :canonicalUrl="url('/prestasi')"
  />
  <!-- Favicon -->
